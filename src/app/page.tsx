    ...
    <div className="w-full max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <header className="mt-6 mb-8 md:mt-10 md:mb-12">
        <div className="text-center">
          ...
          <p className="text-base md:text-lg text-[var(--linkedin-gray-medium)] max-w-2xl mx-auto">
            {t.pageDescription}
          </p>
        </div>
      </header>
      ...
      <div className="mb-16 max-w-4xl mx-auto">
        ...
        <div className="mb-6 p-4 border border-[var(--linkedin-blue-light)] bg-blue-50 text-[var(--linkedin-blue-primary)] rounded-[var(--linkedin-border-radius)]">
          <div className="flex">
      ...
      <footer className="py-6 border-t border-[var(--linkedin-gray-border)]">
        <div className="flex flex-col md:flex-row justify-between items-center">
          <div className="flex items-center mb-3 md:mb-0">
            {/* LinkedIn-style logo */}
            <svg className="h-6 w-6 text-[var(--linkedin-blue-primary)] mr-2" viewBox="0 0 24 24" fill="currentColor">
              <path d="M19 3a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h14m-.5 15.5v-5.3a3.26 3.26 0 0 0-3.26-3.26c-.85 0-1.84.52-2.32 1.3v-1.11h-2.79v8.37h2.79v-4.93c0-.77.62-1.4 1.39-1.4a1.4 1.4 0 0 1 1.4 1.4v4.93h2.79M6.88 8.56a1.68 1.68 0 0 0 1.68-1.68c0-.93-.75-1.69-1.68-1.69a1.69 1.69 0 0 0-1.69 1.69c0 .93.76 1.68 1.69 1.68m1.39 9.94v-8.37H5.5v8.37h2.77z"></path>
            </svg>
            <span className="text-sm font-semibold text-[var(--linkedin-gray-dark)]">
